...
def show_folder(app):
    ...
    tk.Button(app.main_content, text="🗑 Xoá tất cả bản đồ đã lưu", font=("Arial", 11), bg="#e74c3c", fg="white",
              command=lambda: delete_all_maps(app)).pack(pady=(5, 15))
